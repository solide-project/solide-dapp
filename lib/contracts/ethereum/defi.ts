...
export const items = [
    {
        title: "Aave Oracle",
        tutorial: "https://github.com/SovaSniper/tutorials/blob/master/ethereum/AaveOracle.md",
        ...
        description: "Aave Protocol V3, designed to fetch and manage asset prices using Chainlink Aggregators as the primary source. The contract ensures reliable pricing data for decentralized applications within the Aave ecosystem that integrates critical price information into Aave's decentralized lending and borrowing infrastructure.",
        playground: {
            default: {
    ...
    },
    {
        ...
        tutorial: "https://github.com/SovaSniper/tutorials/blob/master/ethereum/CompoundTimelock.md",
