...
export const items = [
    ...
    },
    {
        ...
        tutorial: "https://github.com/SovaSniper/tutorials/blob/master/ethereum/SandboxLandV3.md",
        description: "The official Sandbox LAND NFT in The Sandbox's metaverse. Serves as digital real estate for publishing experiences and populating them with assets, with each unique LAND represented as a non-fungible ERC-721 token on the Ethereum blockchain.",
        playground: {
            default: {
