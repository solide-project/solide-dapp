...
const Aave_DefaultReserveInterestRateStrategy_CONTRACT = "0xfe8FF9a19E251fe6cf2e8cBf0959ACa9624A97d1";
const StarLedgerNFT_CONTRACT = "0x013f3A02De41Bb822bf463ac34F86A2B4936541f";

export const items = [
    {
        title: "Hermes Token",
        tutorial: "https://github.com/SovaSniper/tutorials/blob/master/metis/HermesToken.md",
        description: "Hermes token (HERMES) adhering to the ERC-20 standard. With a focus on simplicity and versatility, it enables seamless token transfers, approvals, and features a controlled minting mechanism.",
        playground: {
            default: {
    ...
    },
    {
        ...
        tutorial: "https://github.com/SovaSniper/tutorials/blob/master/metis/StarLedgerNFT.md",
        description: "NFT collection of 5000 stars, each intricately crafted from real astronomical data. Leveraging the efficiency of Metis L2, the contract introduces a seamless and gas-efficient experience for users, offering accessible minting methods, presale functionality, and comprehensive administrative control.",
        playground: {
            default: {
