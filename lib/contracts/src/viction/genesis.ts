...
export const items = async (): Promise<ContractSchema[]> => {
    const response = await fetch("https://raw.githubusercontent.com/BuildOnViction/tomoscan/ee9e0afd90bf06ac9c3ede1ca7785d07fa2cb7a6/server/src/contracts/contractAddress.json")
