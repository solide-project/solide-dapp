...
export const items = async (): Promise<ContractSchema[]> => {
    ...
    const outdated = "Contract verified, however project not verified. Please view with caution.";
