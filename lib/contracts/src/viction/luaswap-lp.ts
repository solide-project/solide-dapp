...
import { tutorial, reference } from "./luaswap-pool";
...
export const items = async (): Promise<ContractSchema[]> => {
    const response = await fetch("https://raw.githubusercontent.com/luaswap/tomowallet-rpc/master/luaswapOnTomochain/pairList.json")
