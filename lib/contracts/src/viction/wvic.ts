...
export const items: ContractSchema[] = [
    ...
    },
    {
        ...
        tutorial: "",
        reference: "https://www.vicscan.xyz/token/0xC054751BdBD24Ae713BA3Dc9Bd9434aBe2abc1ce#code",
        playground: {
            default: {
    ...
    },
    {
        ...
        description: "VIC-wrapped ETH, called TOMOE, is an ERC20 token hosted on the Ethereum blockchain and backed by an equal amount of native VIC (on the Viction blockchain). One TOMOE is worth the same as one native VIC at any given moment.",
        tutorial: "https://github.com/BuildOnViction/gitbook/blob/main/victionbridge/tomoe.md",
