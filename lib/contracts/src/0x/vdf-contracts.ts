...
export const items = async (): Promise<ContractSchema[]> => {
    return await getContractsByGithub({
        ...
        description: "Verifiable Delay Function (VDF) verifier contract. VDFs are cryptographic functions designed to introduce a time delay in their evaluation, and they have applications in various fields, including blockchain and decentralized systems implemented by 0x Project.",
    });
}