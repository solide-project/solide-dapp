...
export const items = async (): Promise<ContractSchema[]> => {
    return await getContractsByGithub({
        ...
        tutorial: "https://github.com/0xProject/exchange-v3/blob/development/contracts/multisig/README.md",
        description: "This package contains various types of multisignature wallet contracts, including the AssetProxyOwner contract that is responsible for upgrading the 0x protocol smart contracts.",
