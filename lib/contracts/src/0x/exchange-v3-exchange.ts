...
export const items = async (): Promise<ContractSchema[]> => {
    return await getContractsByGithub({
        ...
        tutorial: "https://github.com/0xProject/exchange-v3/blob/development/contracts/exchange/README.md",
        description: "This contract is responsible for settling trades and is typically the entry point for all transactions that interact with the 0x protocol.",
