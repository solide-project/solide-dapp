...
export const items = async (chain: string) => {
  ...
  Object.entries(data.Comptroller as COMPContracts).forEach(([key, val]) => {
    ...
    ret.push({
      ...
      tutorial: "https://github.com/compound-finance/compound-finance.github.io/blob/master/docs/pages/v2/comptroller.md",
  ...
  Object.entries(data.CTokenDelegate as COMPContracts).forEach(([key, val]) => {
    ...
    ret.push({
      ...
      tutorial: "",
      reference: "https://github.com/compound-finance/compound-protocol/blob/master/contracts/CErc20Delegate.sol",
  ...
  Object.entries(data.cTokens as Record<string, COMPToken>).forEach(([key, val]) => {
    ret.push({
      title: `Compound cTokens: ${val.name} (${val.symbol})`,
      tutorial: "https://github.com/compound-finance/compound-finance.github.io/blob/master/docs/pages/v2/ctokens.md",
      reference: "https://github.com/compound-finance/compound-protocol/blob/master/contracts/CErc20Delegate.sol",
