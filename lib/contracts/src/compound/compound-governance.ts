...
export const items = async (): Promise<ContractSchema[]> => await getContractsByGithub({
  ...
  tutorial: "https://github.com/compound-finance/compound-finance.github.io/blob/master/docs/pages/v3/governance.md",
  reference: "https://github.com/compound-finance/compound-governance/tree/main",
  description:
