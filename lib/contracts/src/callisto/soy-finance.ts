...
export const items = async (): Promise<ContractSchema[]> => {
  const response = await fetch(
    "https://raw.githubusercontent.com/CallistoEnterprise/soy-finance/main/src/constants/farmlist.json"
  )
      ...
      ...[
        {
          ...
          tutorial:
            "https://github.com/CallistoEnterprise/SOY-Smart-Contracts/blob/main/README.md",
