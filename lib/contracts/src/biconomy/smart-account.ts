...
export const items = async (): Promise<ContractSchema[]> => await getContractsByGithub({
    ...
    url: "https://api.github.com/repos/bcnmy/scw-contracts/contents/contracts/smart-account?ref=b5be5399ef0e411b62b4342e12a15e34c35bb83c",
    tutorial: "https://github.com/bcnmy/scw-contracts/blob/main/README.md",
