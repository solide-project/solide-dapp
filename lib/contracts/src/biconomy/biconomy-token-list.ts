...
export const items = async (): Promise<ContractSchema[]> => {
    const response = await fetch("https://raw.githubusercontent.com/bcnmy/biconomy-paymasters/4b0a5aecbb3c1d142bb42ccb1f00c67f981fc58c/scripts/configs/prod/token-config-polygon-mainnet.json")
    ...
    const tutorial = "https://github.com/bcnmy/biconomy-paymasters/blob/main/README.md"
    const reference = "https://github.com/bcnmy/biconomy-paymasters/blob/main/scripts/configs/prod/token-config-polygon-mainnet.json"
