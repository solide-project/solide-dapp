...
export const items = async (): Promise<ContractSchema[]> => {
  const response = await fetch("https://aave.github.io/aave-addresses/mainnet.json");
  ...
  data.proto.forEach((token: TokenInfo) => {
    ret.push(
      ...[{
        ...
        tutorial: "https://github.com/aave/docs-v3/blob/main/tokens/atoken.md",
        reference:
      ...
      },
      {
        ...
        tutorial: "https://github.com/aave/docs-v3/blob/main/tokens/debttoken.md",
        reference:
          "https://docs.aave.com/developers/v/2.0/deployed-contracts/deployed-contracts",
