...
export const items = async (): Promise<ContractSchema[]> => {
    ...
    return [
        ...
        ...verifiedContracts
            .filter((item: VerifiedContracts) => item.name.toLocaleLowerCase().includes("uniswap"))
            .map((item: VerifiedContracts) => ({
                ...
                tutorial: "https://github.com/Uniswap/v3-periphery/blob/main/README.md|https://github.com/Uniswap/docs/blob/main/docs/contracts/v3/overview.md",
        ...
        ...verifiedContracts
            ...
            .map((item: VerifiedContracts) => ({
                ...
                tutorial: "https://github.com/Timeswap-Labs/Timeswap-V1-Core/blob/main/README.md",
        ...
        ...verifiedContracts
            ...
            .map((item: VerifiedContracts) => ({
                ...
                tutorial: "https://github.com/pentagonxyz/waymont-contracts/blob/master/README.md|https://github.com/pentagonxyz/waymont-contracts/blob/master/INTEGRATION.md",
                reference: "",
                playground: {
                    default: {
                        address: item.address,
