...
import { GitHubFileInfo, fetchGithub, filterFiles } from "../../utils/utils"
import { getContractsByDeployments } from "@/lib/contracts"
import { camelToWord, snakeToWord } from "@/lib/utils"

const addresses: Record<string, string> = {
    "JB1DayReconfigurationBufferBallot": "0xDd9303491328F899796319C2b6bD614324b86314",
    "JB3DayReconfigurationBufferBallot": "0x19D8C293D35EA4b2879A864A68D45a2025694929",
    "JB7DayReconfigurationBufferBallot": "0x8E1AEc30063565e597705E71Ba14Dffc4C390Ef0",
    ...
    "JBSingleTokenPaymentTerminalStore": "0xdF7Ca703225c5da79A86E08E03A206c267B7470C",
    "JBSingleTokenPaymentTerminalStore3_1": "0x77b0A81AeB61d08C0b23c739969d22c5C9950336",
    "JBSingleTokenPaymentTerminalStore3_1_1": "0x82129d4109625F94582bDdF6101a8Cd1a27919f5",
    "JBSplitsStore": "0x0D25194ABE95185Db8e4B0294F5669E21C534785",
    "JBTokenStore": "0x6FA996581D7edaABE62C15eaE19fEeD4F1DdDfE7"
}

const tutorial = "https://github.com/jbx-protocol/juice-docs-v3/blob/master/docs/dev/learn/architecture/README.md|https://github.com/jbx-protocol/juice-docs-v3/blob/master/docs/dev/learn/architecture/terminals.md"
 ...
 * @returns 
 */
export const items = async (): Promise<ContractSchema[]> => Object.entries(addresses).map(([name, address]) => ({
