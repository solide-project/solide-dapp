...
export const items = async (): Promise<ContractSchema[]> => await getContractsByGithub({
  ...
  tutorial: "https://github.com/jbx-protocol/juice-ve-nft/blob/master/README.md",
  reference: "https://github.com/jbx-protocol/juice-ve-nft/tree/master",
  description: "Issue an NFT that represents a locked position of juicebox project tokens (unclaimed or as ERC20s).",
  remappings: {
