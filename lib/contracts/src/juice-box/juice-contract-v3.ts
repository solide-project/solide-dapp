...
export const items = async (): Promise<ContractSchema[]> => await getContractsByGithub({
  ...
  tutorial: "https://github.com/jbx-protocol/juice-docs-v3/blob/master/docs/dev/learn/architecture/README.md|https://github.com/jbx-protocol/juice-docs-v3/blob/master/docs/dev/learn/architecture/terminals.md",
