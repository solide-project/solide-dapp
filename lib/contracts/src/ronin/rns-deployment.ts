...
import { getContractsByDeployments, getContractsByGithub } from "@/lib/contracts"
...
export const items = async (chain: string): Promise<ContractSchema[]> => {
    ...
    const ret: ContractSchema[] = Object.entries(addresses).map(([key, val]) => {
        ...
        return {
            ...
            tutorial: "https://github.com/axieinfinity/ronin-documentation/blob/main/docs/apps/rns/overview.md",
            reference: "https://github.com/axieinfinity/ronin-bridge-contracts/tree/mainnet/deployments",
