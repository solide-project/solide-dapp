...
export const items = async ({
    ...
    const response = await fetch("https://skynet-api.roninchain.com/ronin/tokens/search", requestOptions)
    ...
    data.result.items
        ...
        .forEach((item: Item) => {
            ret.push({
                ...
                outdated: "Note these tokens are not audited nor officially supported by Ronin, please explore these token at your own risk."
            })
        })
    return ret
}