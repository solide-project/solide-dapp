...
import { getContractsByDeployments } from "../../utils/get-contracts-by-deployments";
import { GitHubFileInfo, filterFiles } from "../../utils/utils";
...
export const items = async (chain: string): Promise<ContractSchema[]> => {
    const response = await fetch("https://api.github.com/repos/safe-global/safe-deployments/contents/src/assets/v1.3.0")
