...
export const items = async (): Promise<ContractSchema[]> => {
    return await getContractsByGithub({
        ...
        description: "The core is the community contract, managing members and ERC20 tokens on Fuse and Ethereum with a Multitoken bridge. This integration offers a user-friendly solution for launching and managing DeFi communities.",
    });
}
