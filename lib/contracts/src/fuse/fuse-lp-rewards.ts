...
export const items = async (): Promise<ContractSchema[]> => {
    const response = await fetch("https://raw.githubusercontent.com/fuseio/fuse-lp-rewards/master/config/default.json")
    ...
    Object.entries(data.contracts.fuse).forEach(([key, val]: any) => {
        ret.push({
            ...
            tutorial: "https://github.com/fuseio/fuse-lp-rewards/blob/master/solidity/README.md",
