...
export const items = async (): Promise<ContractSchema[]> => {
    const response = await fetch("https://raw.githubusercontent.com/fuseio/fuse-wallet-contracts/main/utils/versions/fuse.prod/latest.json")
    ...
    data.modules.forEach((item: { address: string, name: string }) => {
        ...
        ret.push({
            ...
            tutorial: "https://github.com/fuseio/fuse-wallet-contracts/blob/main/README.md",
