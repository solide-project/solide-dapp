...
export const items = async (): Promise<ContractSchema[]> => await getContractsByGithub({
    ...
    outdated: "Note Permits contracts require viaIR complication which is not yet supported by Solide",
    docRemappings: {
        "SignatureTransfer": "https://github.com/Uniswap/docs/blob/main/docs/contracts/permit2/reference/signature-transfer.md",
        "AllowanceTransfer": "https://github.com/Uniswap/docs/blob/main/docs/contracts/permit2/reference/allowance-transfer.md"
    }
})
