...
export const items = async (chain: string) => {
    ...
    Object.entries(data).forEach(([key, val]) => {
        ...
        ret.push({
            ...
            tutorial: "https://github.com/Uniswap/docs/blob/main/docs/contracts/universal-router/01-overview.md|https://github.com/Uniswap/docs/blob/main/docs/contracts/universal-router/02-technical-reference.md",
