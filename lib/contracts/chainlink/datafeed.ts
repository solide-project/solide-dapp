...
export const items = [
    ...
    },
    {
        ...
        tutorial: "",
        reference: "https://docs.chain.link/data-feeds/rates-feeds/addresses?network=ethereum&page=1#sepolia-testnet",
        description: "Rate and Volatility Feed Addresses of LINK/USD Pair on Ethereum Sepolia Testnet",
        playground: {
            default: {
    ...
    },
    {
        ...
        tutorial: "",
        reference: "https://docs.chain.link/data-feeds/rates-feeds/addresses?network=ethereum&page=1#sepolia-testnet",
        description: "Rate and Volatility Feed Addresses of 90-Day ETH APR on Ethereum Sepolia Testnet",
        playground: {
            default: {
