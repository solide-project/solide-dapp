export const items = [
    ...
    },
    {
        ...
        tutorial: "https://github.com/smartcontractkit/ccip-tic-tac-toe/blob/main/README.md",
        reference: "https://github.com/smartcontractkit/ccip-tic-tac-toe",
        description: "The Chainlink CCIP Tic-Tac-Toe project offers a practical example of cross-chain gaming, demonstrating the potential for decentralized applications to seamlessly interact across different blockchains. Developers can leverage this example to understand CCIP integration, enhance security measures.",
        playground: {
            default: {
        ...
        playground: {
            ...
            chains: {
                ...
                ["CrossChainNameServiceReceiver.sol"]: {
                    address: "https://raw.githubusercontent.com/smartcontractkit/ccip-cross-chain-name-service/main/contracts/CrossChainNameServiceReceiver.sol",
                    version: "v0.8.19+commit.7dd6d404",
                },
                ["CrossChainNameServiceRegister.sol"]: {
                    address: "https://raw.githubusercontent.com/smartcontractkit/ccip-cross-chain-name-service/main/contracts/CrossChainNameServiceRegister.sol",
                    version: "v0.8.19+commit.7dd6d404",
                },
            }
        },
    },
    {
        ...
        tutorial: "https://github.com/smartcontractkit/ccip-defi-lending/blob/main/README.md",
        reference: "https://github.com/smartcontractkit/ccip-defi-lending",
        description: "The CCIP Cross Chain Name Service (CCNS) exemplified in this project illustrating the implementation of a minimal cross-chain name service using Chainlink CCIP (Cross-Chain Interoperability Protocol). It allows users to register and resolve custom .ccns handles across multiple supported blockchains, providing a decentralized and interoperable naming solution.",
        playground: {
            default: {
                address: "https://raw.githubusercontent.com/smartcontractkit/ccip-defi-lending/main/contracts/Protocol.sol",
                version: "v0.8.19+commit.7dd6d404",
            },
            chains: {
                ["Protocol.sol"]: {
                ...
                ["MockUSDC.sol"]: {
                    address: "https://raw.githubusercontent.com/smartcontractkit/ccip-defi-lending/main/contracts/MockUSDC.sol",
                },
                ["Sender.sol"]: {
                    address: "https://raw.githubusercontent.com/smartcontractkit/ccip-cross-chain-name-service/main/contracts/Sender.sol",
                    version: "v0.8.19+commit.7dd6d404",
                },
            }
        },
