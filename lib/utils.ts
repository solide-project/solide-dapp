...
// export const SolideURL = "http://localhost:3000"
export const SolideURL = "https://solidewidget.azurewebsites.net" // Azure deployment fixes timeout issue (that Vercel has)
