...
export const NavBar = ({ }: NavBarProps) => {
    ...
    return <div className="sticky top-0 z-40 w-full border-b bg-background">
        <div className="container flex h-16 items-center justify-between py-6">
            <div className="flex gap-6 md:gap-10">
                ...
                <button className="flex items-center space-x-2 md:hidden" onClick={handleNavBar}>
                    <Icon icon="lucide:menu" />
                    <span className="font-bold">Menu</span>
                </button>
                <div className={cn("fixed inset-0 top-16 z-50 grid h-[calc(100vh-4rem)] grid-flow-row auto-rows-max overflow-auto p-6 pb-32 shadow-md animate-in slide-in-from-bottom-80 md:hidden", `${showNavBar ? "visible" : "hidden"}`)}>
            ...
            <nav className="hidden md:flex items-center z-50" style={{ zIndex: 999 }}>
                <FeedBackButton />
                <ThemeToggle />
                <NavButton />
            </nav>
